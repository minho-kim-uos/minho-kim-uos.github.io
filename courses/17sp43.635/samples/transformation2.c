...
void display(void)
{
	...
	glPushMatrix();
		...
		glPushMatrix();
			glColor3f(.3,.3,.3);
			glTranslatef((upper.box.length-upper.box.thickness)/2.0, 0, 0);
			glScalef(upper.box.length, upper.box.thickness, 1);
			render_square();
		glPopMatrix();
		glColor3f(1,1,1);
		glBegin(GL_POINTS);
		...
		glPushMatrix();
			...
			glPushMatrix();
				glColor3f(.5,.5,.5);
				glTranslatef((lower.length-lower.thickness)/2.0, 0, 0);
				glScalef(lower.length, lower.thickness, 1);
				render_square();
			glPopMatrix();
			glColor3f(1,1,1);
			glBegin(GL_POINTS);
			...
			glPushMatrix();
				...
				glPushMatrix();
					glColor3f(.8,.8,.8);
					glTranslatef((hand.length-hand.thickness)/2.0, 0, 0);
					glScalef(hand.length, hand.thickness, 1);
					render_square();
				glPopMatrix();
				glColor3f(1,1,1);
				glBegin(GL_POINTS);
